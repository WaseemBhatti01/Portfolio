...
// Start typing animation & init page interactions when loaded
window.addEventListener('load', () => {
    ...
    if (aboutMore && aboutToggle) {
        ...
        aboutToggle.addEventListener('click', () => {
            ...
            const label = aboutToggle.querySelector('.btn-text');
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        const mailtoLink = `mailto:waseemnadeem453@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
window.addEventListener('load', () => {
    ...
    if (accountButton && isAndroidDevice()) {
        const accountId = '6973226670096639846';
